...
<div class="wenxin">
    <div class="top">        
        <span class="a"><img src="zfb.png"> <strong>支付宝扫码支付</strong></span> 
        <span class="b">亿万用户选择，更快更安全！</span>
        <span class="c">支付：<strong style="font-size:18px;color:#F60;"><?php echo $payAmount ?></strong>元</span>
    </div>
    <div class="codeimg"><img src="smimg/zfb<?php echo $payAmount ?>.jpg" style="width: 90%; margin: 0px auto; max-width: 320px;"></div>
</div>


<div align="center" style="font-family: '微软雅黑'; font-size: 18px; color: #071BF5; max-width: 580px; width: 100%; margin: 0px auto;" >请用手机打开支付宝APP，扫一扫上面的二维码图案（本机的话请长按二维码图片，保存到手机相册，再运行支付宝APP，扫码刚刚保存的二维码图片），<br>免手续费向本站付款<span style="color: #F50707"><?php echo $payAmount ?></span>元。<br>付款前请确保收款支付宝账号是<span style="color: #F50707"><?php echo $optEmail ?></span>，建议付款说明中填写亲提交订单时填写的手机号码“<span style="color: #F50707"><?php echo $smsNo ?></span>”，方便核对订单信息，谢谢！<br>
