...
<title>CLPHP订单系统2017 WEB、WAP自适应版官方正式版 - 样式01</title>
          ...
          <form id="clform" name="clform" action="../clorder.php" method="post" onsubmit="return postcheck()" target="_parent">
            ...
            <div class="clbdbox">
              ...
              <div class="cldxbox red">
                <input type="radio" name="bdproduct" id="bdproduct1" value="恭恭恭恭恭恭 2盒 385元" alt="385" onclick="pricea()">
                <label for="bdproduct1">恭恭恭恭恭恭 2盒 385元</label>
                <br>
                <input type="radio" checked name="bdproduct" id="bdproduct2" value="喜喜喜喜喜喜 4盒 580元" alt="580" onclick="pricea()">
                <label for="bdproduct2">喜喜喜喜喜喜 4盒 580元 <img src="images/tj.gif"></label>
                <br>
                <input type="radio" name="bdproduct" id="bdproduct3" value="发发发发发发 6盒 785元" alt="785" onclick="pricea()">
                <label for="bdproduct3">发发发发发发 6盒 785元</label>
                <br>
                <input type="radio" name="bdproduct" id="bdproduct4" value="财财财财财财 8盒 960元" alt="960" onclick="pricea()">
                <label for="bdproduct4">财财财财财财 8盒 960元</label>
                <br>
              </div>
            </div>
