...
<title>CLPHP订单系统2017 WEB、WAP自适应版官方正式版 - 样式02</title>
...
#clorder{width:100%;max-width:950px;background:#FFF;}

.clwarp{border:5px solid #33ADFF;}

.cltitlea,.cltitleb{border-bottom:1px solid #33ADFF;}

.clrxian{border-right:1px solid #33ADFF;}

.clsubbox input{background:#33ADFF;}
        ...
        <input type="hidden" name="bdprice" value="580" />
                ...
                <div class="clbdbox">
                    ...
                    <div class="cldxbox red">
                        ...
                        <input type="radio" name="bdproduct" id="bdproduct1" value="恭恭恭恭恭恭 2盒 385元" alt="385" onclick="pricea()"><label for="bdproduct1">恭恭恭恭恭恭 2盒 385元</label><br>

                        <input type="radio" checked name="bdproduct" id="bdproduct2" value="喜喜喜喜喜喜 4盒 580元" alt="580" onclick="pricea()"><label for="bdproduct2">喜喜喜喜喜喜 4盒 580元 <img src="images/hot.gif"></label><br>
                        <input type="radio" name="bdproduct" id="bdproduct3" value="发发发发发发 6盒 785元" alt="785" onclick="pricea()"><label for="bdproduct3">发发发发发发 6盒 785元</label>
                <br>
                <input type="radio" name="bdproduct" id="bdproduct4" value="财财财财财财 8盒 960元" alt="960" onclick="pricea()"><label for="bdproduct4">财财财财财财 8盒 960元</label>
                <br>
               ...
               <div class="clbdbox">
                    ...
                    <div class="cldxbox">                        
						...
						<p><input type="radio" name="bdproductc" checked id="bdproductc0" value="黑色"><label for="bdproductc0">黑色</label></p><p><input type="radio" name="bdproductc" id="bdproductc1" value="棕色"><label for="bdproductc1">棕色</label></p>                    </div>
                    ...
                    <div class="cltext3box">
                        ...
                        <input type="text" name="bdnum" value="1" onChange="pricea()"> 总价<div id="showprice">580</div>元
...
<div class="clbdbox">
              ...
              <input type="submit" name="bdsubmit" value="立即提交订单" class="clbtn btn-b">
            </div>
