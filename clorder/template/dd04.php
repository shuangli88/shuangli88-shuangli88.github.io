...
<title>CLPHP订单系统2017 WEB、WAP自适应版官方正式版 - 样式04</title>
...
#clorder{width:100%;max-width:960px;background:#FFF;}

.clwarp{border:5px solid #FF3366;}

.cltitlea,.cltitleb{border-bottom:1px solid #FF3366;}

.clrxian{border-right:1px solid #FF3366;}

.clsubbox input{background:#FF3366;}
...
<div class="clwarp">
    ...
    <div class="clorderl">
        ...
        <div class="clforml" id="clforml">
            ...
            <label class="clbdxx">选择型号</label>

            <div class="clxlbox">

                <select name="bdproducta" class="clcpxl">

                    <option selected value="型号一">型号一</option>
