...
<title>CLPHP订单系统2017 WEB、WAP自适应版官方正式版 - 样式06</title>
...
.clwarp{border:5px solid #5FB878;}

.cltitlea,.cltitleb{border-bottom:1px solid #5FB878;}

.clrxian{border-right:1px solid #5FB878;}

.clsubbox input{background:#5FB878;}
...
<div class="clwarp">
        ...
        <input type="hidden" name="bdprice" value="580" />
                ...
                <div class="clbdbox">
                    ...
                    <div class="cldxbox red">
                       ...
                       <p> <input type="radio" name="bdproduct" id="bdproduct1" value="恭恭恭恭恭恭 2盒 385元" alt="385" onclick="pricea()"><label for="bdproduct1">恭恭恭恭恭恭 2盒 385元</label><br></p>

                       <p> <input type="radio" checked name="bdproduct" id="bdproduct2" value="喜喜喜喜喜喜 4盒 580元" alt="580" onclick="pricea()"><label for="bdproduct2">喜喜喜喜喜喜 4盒 580元 <img src="images/hot.gif"></label><br></p>

                       <p> <input type="radio" name="bdproduct" id="bdproduct3" value="发发发发发发 6盒 785元" alt="785" onclick="pricea()"><label for="bdproduct3">发发发发发发 6盒 785元</label><br></p>

                       <p> <input type="radio" name="bdproduct" id="bdproduct4" value="财财财财财财 8盒 960元" alt="960" onclick="pricea()"><label for="bdproduct4">财财财财财财 8盒 960元</label><br></p>
    ...
    <div class="clbdbox">
                    ...
                    <div class="clxlbox">
                        ...
                        <select id="bdproductc" name="bdproductc"  class="clcpxl red">

                            <option selected value="颜色一" title="颜色一">颜色一</option>

                            <option value="颜色二" title="颜色二">颜色二</option>

                            <option value="颜色三" title="颜色三">颜色三</option>

                            <option value="颜色四" title="颜色四">颜色四</option>
            ...
            <div class="clbdbox">
              ...
              <div class="cltext3box">
                <select id="bdnum" name="bdnum" onChange="pricea()" class="clcpxl">
                  <option selected value="1" title="订购数量1">1</option>
                  <option value="2" title="订购数量2">2</option>
                  <option value="3" title="订购数量3">3</option>
                  <option value="4" title="订购数量4">4</option>
                  <option value="5" title="订购数量5">5</option>
                  <option value="6" title="订购数量6">6</option>
                  <option value="7" title="订购数量7">7</option>
                  <option value="8" title="订购数量8">8</option>
                  <option value="9" title="订购数量9">9</option>
                  <option value="10" title="订购数量10">10</option>
                </select>
                总价
                <div id="showprice">580</div>
                元 </div>
            </div>
...
<div class="clbdbox">
              ...
              <input type="submit" name="bdsubmit" value="立即提交订单" class="clbtn btn-g">
            </div>
