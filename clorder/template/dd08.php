...
<title>CLPHP订单系统2017 WEB、WAP自适应版官方正式版 - 样式08</title>
...
.clwarp{border:5px solid #F90;}

.cltitlea,.cltitleb{border-bottom:1px solid #F90;}

.clrxian{border-right:1px solid #F90;}

.clsubbox input{background:#F90;}
...
<div class="clwarp">
 ...
 <div class="clbdbox">
                    ...
                    <div class="cldxbox red">
                        ...
                        <input type="radio" name="bdproducta" id="bdproductb1" value="型号一" ><label for="bdproductb1">型号一</label>&nbsp;&nbsp;&nbsp;&nbsp;

                        <input type="radio" checked name="bdproducta" id="bdproductb2" value="型号二" ><label for="bdproductb2">型号二</label>&nbsp;&nbsp;&nbsp;&nbsp;

                        <input type="radio" name="bdproducta" id="bdproductb3" value="型号三" ><label for="bdproductb3">型号三</label>&nbsp;&nbsp;&nbsp;&nbsp;

                        <input type="radio" name="bdproducta" id="bdproductb4" value="型号四" ><label for="bdproductb4">型号四</label>
