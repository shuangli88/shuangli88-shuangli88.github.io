...
<title>CLPHP订单系统2017 WEB、WAP自适应版官方正式版 - 样式19</title>
    ...
    <div class="item-content">
      <div class="alizi-booking clearfix" id="aliziOrder">
        <div class="alizi-main" >
          <div class="order-title main-title ellipsis">恭恭恭恭恭恭</div>
          <div class="order-content">
            <form id="clform" name="clform" action="../clorder.php" method="post" onsubmit="return postcheck()" target="_parent" class="ajaxForm">
              ...
              <div class="rows clearfix">
                <div class="clearfix"> <a alizi-price="385" alizi-title="型号一" class="left badge ellipsis alizi-product-params active" href="javascript:;">型号一</a> <a alizi-price="580" alizi-title="型号二" class="left badge ellipsis alizi-product-params " href="javascript:;">型号二</a> </div>
              </div>
              <div class="rows clearfix">
                <div class="rows clearfix">
              ...
              <div class="rows clearfix">
                <div class="rows clearfix">
                  ...
                  <div class="rows-params left"> <span class="alizi-radio-group"> <span class="alizi-radio">
                    <input id="选择颜色0" name="bdproductc" type="radio" value="红色" checked>
                    <label for="选择颜色0"></label>
                    </span> 红色 </span><span class="alizi-radio-group"> <span class="alizi-radio">
                    <input id="选择颜色1" name="bdproductc" type="radio" value="蓝色" >
                    <label for="选择颜色1"></label>
                    </span> 蓝色 </span><span class="alizi-radio-group"> <span class="alizi-radio">
                    <input id="选择颜色2" name="bdproductc" type="radio" value="白色" >
                    <label for="选择颜色2"></label>
                    </span> 白色 </span> </div>
                </div>
              </div>
              <div class="rows clearfix">
              ...
              <div class="rows clearfix">
                ...
                <div class="rows-params">
                  <textarea name="bdother" placeholder="请填写留言或备注" class="input-text" rows="2"></textarea>
                </div>
              </div>
	 ...
	 <div class="rows clearfix">
              ...
              <div class="rows mtop">
                <button type="bumit" name="bdsubmit" class="btn-submit btn btn-green" >确认提交</button>
              </div>
            </form>
          </div>
        </div>
