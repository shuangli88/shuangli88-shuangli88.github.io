...
<head>
	...
	<title>CLPHP订单系统2017 WEB、WAP自适应版官方正式版 - 样式20</title>
...
<script type="text/javascript" src="js/cl.min1.js"></script>
...
<div class="newmain background" id="tab_box">
	...
	<div class="alizi-main" >
		...
		<div class="order-title main-title ellipsis">在线快速订购</div>
         ...
         <input type="hidden" value="" name="referer" id="referer">
              ...
              <div class="rows clearfix">
						...
						<div class="rows clearfix">
							...
							<label class="head left">选择产品</label>

							<div class="rows-params left">
                            <a alizi-price="385" alizi-title="恭恭恭恭恭恭385元" class="left badge ellipsis alizi-clproduct-params active" href="javascript:;">恭恭恭恭恭恭385元</a>
                             <a alizi-price="580" alizi-title="喜喜喜喜喜喜 4盒 580元" class="left badge ellipsis alizi-clproduct-params " href="javascript:;">喜喜喜喜喜喜 4盒 580元</a> </div>
             ...
             <div class="rows clearfix">
						...
						<div class="rows clearfix">
							...
							<div class="rows-params left">
                            <a  alizi-title="型号一" class="left badge ellipsis alizi-product-params active" href="javascript:;">型号一</a>
                             <a  alizi-title="型号二" class="left badge ellipsis alizi-product-params " href="javascript:;">型号二</a> 
                             <a  alizi-title="型号三" class="left badge ellipsis alizi-product-params " href="javascript:;">型号三</a> </div>
              </div>				
</div>
              <div class="rows clearfix">
                <div class="rows clearfix">
              ...
              <div class="rows clearfix">
						...
						<div class="rows clearfix">
							...
							<label class="head left">选择颜色</label>

							<div class="rows-params left">

								<span class="alizi-radio-group">

									<span class="alizi-radio"><input id="选择颜色0" name="bdproductc" type="radio" value="红色" checked><label for="选择颜色0"></label></span>

									红色								</span><span class="alizi-radio-group">

									<span class="alizi-radio"><input id="选择颜色1" name="bdproductc" type="radio" value="蓝色" ><label for="选择颜色1"></label></span>

									蓝色								</span><span class="alizi-radio-group">

									<span class="alizi-radio"><input id="选择颜色2" name="bdproductc" type="radio" value="白色" ><label for="选择颜色2"></label></span>
				...
				<div class="rows clearfix">
						...
						<div class="rows-params">
									...
									<a class="bdnum-dec" href="javascript:alizibdnum(-1)">-</a>

									<input type="tel" class="quantity" size="4" value="1" name="bdnum" onkeyup="alizibdnum(0)">

									<a class="bdnum-inc" href="javascript:alizibdnum(1)">+</a>
...
<div class="rows clearfix">
						...
						<span><i class="alizi-total-price bright">385.00</i>元</span>						</div>
					...
					<div class="rows clearfix">
						...
						<div class="rows-params">
														...
														<input type="text" name="bdname" placeholder="请填写姓名" value="" autocomplete="off" class="input-text left">						</div>

					</div><div class="rows clearfix">

						<label class="head left">客户手机</label>

						<div class="rows-params">

						<input type="tel" name="bdmob" placeholder="请填写手机号码" value="" autocomplete="off" class="input-text left">						</div>
						...
						<select name="bdprovince" id="province-0" class="select1"></select>

								<select name="bdcity" id="city-0" class="select1"></select>

								<select name="bdarea" id="area-0" class="select1"></select>
...
<script type="text/javascript" src="js/cldq.js" charset="utf-8"></script>
						...
						<div class="rows-params">
														...
														<input type="text" name="bdaddress" placeholder="请填写详细地址" value="" autocomplete="off" class="input-text left">						</div>
						...
						<textarea name="bdother" class="input-text" rows="2" placeholder="请填写留言或备注"></textarea>						</div>
...
<div class="rows clearfix">
	...
	<div class="rows-params">
			...
			<a class="alizi-radio-group">

			<span class="alizi-radio"><input class="payments" alizi-key="1" id="pay1" name="bdpay" type="radio" value="cod" checked><label for="pay1"></label></span>

			货到付款		</a>		<a class="alizi-radio-group">

			<span class="alizi-radio"><input class="payments" alizi-key="3" id="pay3" name="bdpay" type="radio" value="alipay" ><label for="pay3"></label></span>

			支付宝付款		</a>		<a class="alizi-radio-group">

			<span class="alizi-radio"><input class="payments" alizi-key="2" id="pay2" name="bdpay" type="radio" value="wx" ><label for="pay2"></label></span>

			微信付款		</a>		<a class="alizi-radio-group">

			<span class="alizi-radio"><input class="payments" alizi-key="5" id="pay5" name="bdpay" type="radio" value="bank" ><label for="pay5"></label></span>
...
<div id="payment-info" class="rows clearfix">
	...
	<input type="hidden" name="shipping_price" value="0">
				...
				<div class="rows mtop">
					...
					<button type="bumit" name="bdsubmit" class="btn-submit btn btn-yellow" >确认提交</button>
