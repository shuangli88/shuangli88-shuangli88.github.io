...
<title>CLPHP订单系统2017 WEB、WAP自适应版官方正式版 - 样式21</title>
  ...
  <div class="content">
    <div class="item-content">
              ...
              <div class="rows clearfix">
                <div class="rows clearfix">
                  ...
                  <div class="rows-params left">
                    <div class="clearfix">
                     <a alizi-price="385" alizi-title="型号一" class="left badge ellipsis alizi-product-params active" href="javascript:;"><img src='cpimg/2101.jpg' width="90"/><br>  <center>型号一</center> </a>
                      <a alizi-price="580" alizi-title="型号二" class="left badge ellipsis alizi-product-params " href="javascript:;"><img src='cpimg/2102.jpg' width="90"/><br><center>型号二</center></a>
                      <a alizi-price="785" alizi-title="型号三" class="left badge ellipsis alizi-product-params " href="javascript:;"><img src='cpimg/2103.jpg' width="90"/><br><center>型号三</center></a> 
                      <a alizi-price="960" alizi-title="型号四" class="left badge ellipsis alizi-product-params " href="javascript:;"><img src='cpimg/2104.jpg' width="90"/><br><center>型号四</center></a> 
                      </div>
                  </div>
                </div>
              </div>
              <div class="rows clearfix">
                <div class="rows clearfix">
                  ...
                  <div class="rows-params left"> <span class="alizi-radio-group"> <span class="alizi-radio">
                    ...
                    </span> L </span> <span class="alizi-radio-group"> <span class="alizi-radio">
	 ...
	 <div class="rows clearfix">
              ...
              <div class="rows mtop">
                <button type="bumit" name="bdsubmit" class="btn-submit btn btn-red" >确认提交</button>
              </div>
            </form>
          </div>
        </div>
