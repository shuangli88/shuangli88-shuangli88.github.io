...
var bdnum=document.clform.bdnum.value;var bdprice=bdproduct*bdnum;document.clform.bdprice.value=bdprice;document.getElementById("showprice").innerHTML=bdprice.toFixed(2);}
...
document.clform.bdnum.value=bdnum;document.clform.bdprice.value=bdprice;document.getElementById("showmun").innerHTML=bdnum;document.getElementById('showprice').innerHTML=bdprice.toFixed(2);}
...
function cltgp(zk){document.getElementById("clform").target="_parent";try{var bdprice=document.clform.bdprice.value*zk;document.getElementById('showprice').innerHTML=bdprice.toFixed(2);}catch(ex){}}
function cltgb(zk){document.getElementById("clform").target="_blank";try{var bdprice=document.clform.bdprice.value*zk;document.getElementById('showprice').innerHTML=bdprice.toFixed(2);}catch(ex){}}
